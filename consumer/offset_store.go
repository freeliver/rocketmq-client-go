...
import (
	...
	"github.com/freeliver/rocketmq-client-go/v2/internal"
...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/freeliver/rocketmq-client-go/v2/consumer  --package consumer OffsetStore
